...
datasets_path = "/media/oracl4/JuliusHD/datasets/"

cityscape_coco_anno_dir = datasets_path + "cityscapes/coco/"
cityscape_img_path = datasets_path + "cityscapes/raw/"

itri_coco_anno_dir = datasets_path + "itri/coco/"
itri_img_path = datasets_path + "itri/raw/"
...
DATASETS = {
    ...
    # 'cityscapes_train': {
    #     'ann_file': cityscape_coco_anno_dir + "cityscape/" + "annotations/" + "train.json",
    #     'root': cityscape_img_path,
    # },

    # 'cityscapes_val': {
    #     'ann_file': cityscape_coco_anno_dir + "cityscape/" + "annotations/" + "val.json",
    #     'root': cityscape_img_path,
    # },

    # 'cityscapes_test': {
    #     'ann_file': cityscape_coco_anno_dir + "cityscape/" + "annotations/" + "test.json",
    #     'root': cityscape_img_path,
    # },

    # Cityscape Dataset ITRI Format

    'cityscapes_itri_train': {
        'ann_file': cityscape_coco_anno_dir + "itri/" + "annotations/" + "train.json",
        'root': cityscape_img_path,
    },

    'cityscapes_itri_val': {
        'ann_file': cityscape_coco_anno_dir + "itri/" + "annotations/" + "val.json",
        'root': cityscape_img_path,
    },

    'cityscapes_itri_test': {
        'ann_file': cityscape_coco_anno_dir + "itri/" + "annotations/" + "test.json",
        'root': cityscape_img_path,
    },
    ...
    'itri_train': {
        'ann_file': itri_coco_anno_dir + "itri/" + "annotations/" + "train.json",
        'root': itri_img_path,
    },

    'itri_val': {
        'ann_file': itri_coco_anno_dir + "itri/" + "annotations/" + "val.json",
        'root': itri_img_path,
    },

    'itri_test': {
        'ann_file': itri_coco_anno_dir + "itri/" + "annotations/" + "test.json",
        'root': itri_img_path,
    },

    'itri_fine': {
        'ann_file': itri_coco_anno_dir + "itri/" + "annotations/" + "fine.json",
        'root': itri_img_path,
    },

    'itri_extract': {
        'ann_file': itri_coco_anno_dir + "itri/" + "annotations/" + "extract.json",
        'root': itri_img_path,
    }
...
def build_datasets(names, transforms, is_train=True):
    ...
    for name in names:
        ...
        # Insert ITRI Format
            ...
            dataset = CityscapeITRIDataset(**cfg)
        elif 'cityscape_itri' in name:
            dataset = CityscapeITRIDataset(**cfg)
